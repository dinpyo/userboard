...
<%
   ...
   // 2.모델 계층
    ...
    System.out.println( "드라이버 실행 <--- deleteBoardAction");   
   ...
   System.out.println(searchStmt + " <--- deleteBoardAction searchStmt");
   System.out.println(searchRs + " <--- deleteBoardAction searchRs");
   ...
   if(row == 1) {
      System.out.println("게시글 삭제 완료! <--- deleteBoardAction");
      response.sendRedirect(request.getContextPath()+"/home.jsp");
   } else{
      System.out.println("게시글 삭제 실패! <--- deleteBoardAction");
