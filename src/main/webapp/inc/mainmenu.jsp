...
<div class="container">
	<ul class="list-group list-group-horizontal">
		...
		%>
				<li class="list-group-item list-group-item-primary"><a href="<%=request.getContextPath()%>/member/memberInformation.jsp">회원정보</a></li>
				<li class="list-group-item list-group-item-primary"><a href="<%=request.getContextPath()%>/member/logoutAction.jsp">로그아웃</a></li>
				<li class="list-group-item list-group-item-primary"><a href="<%=request.getContextPath()%>/board/selectLocal.jsp">지역목록</a></li>
				<li class="list-group-item list-group-item-primary"><a href="<%=request.getContextPath()%>/board/insertBoardForm.jsp">글 추가</a></li>
		<% 	
			}
		%>
	</ul>
